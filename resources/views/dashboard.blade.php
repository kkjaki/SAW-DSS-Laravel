        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-semibold mb-4">Decision Support System - SAW</h3>
                    ...
                    <!-- Criteria Table -->
                    <div class="mb-6">
                        <h4 class="font-semibold text-md mb-2">Criteria</h4>
                        <table class="min-w-full border-collapse border border-gray-200 dark:border-gray-700">
                            <thead>
                                <tr class="bg-gray-100 dark:bg-gray-700">
                                    ...
                                    <th class="border border-gray-200 dark:border-gray-600 px-4 py-2 text-left">Criteria Name</th>
                    ...
                    <div>
                        ...
                        <table class="min-w-full border-collapse border border-gray-200 dark:border-gray-700">
                            <thead>
                                <tr class="bg-gray-100 dark:bg-gray-700">
                                    <th class="border border-gray-200 dark:border-gray-600 px-4 py-2 text-left">#</th>
                                    <th class="border border-gray-200 dark:border-gray-600 px-4 py-2 text-left">Alternative Name</th>
                                    @foreach ($criteria as $criterion)
                                        <th class="border border-gray-200 dark:border-gray-600 px-4 py-2 text-left">{{ $criterion->name }}</th>
                                    @endforeach
                                </tr>
                            </thead>
                            <tbody>
                                        ...
                                        @foreach ($criteria as $criterion)
                                            @php
                                                $value = $alternative->alternativevalues
                                                    ...
                                                    ->first();
                                            @endphp
                                            <td class="border border-gray-200 dark:border-gray-600 px-4 py-2">{{ $value ? $value->score : '-' }}</td>
                                        @endforeach
                                    </tr>
                                @endforeach
                            </tbody>
